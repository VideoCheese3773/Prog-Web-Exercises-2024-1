...
export function Body() {
    return (
        <main>
            ...
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Neque corrupti velit repellendus cum, porro est quidem quis excepturi, amet vel beatae enim nostrum quos. Blanditiis soluta id nisi aliquam quisquam.</p>
        </main>
    )
}
